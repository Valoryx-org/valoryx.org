...
**Valoryx** utilise un éditeur WYSIWYG basé sur Tiptap qui produit du markdown propre. Il prend en charge les raccourcis markdown, les blocs de code avec coloration syntaxique, les tableaux, les encadrés et les intégrations d'images. L'éditeur est optimisé pour la vitesse — aucune latence perceptible même sur de grands documents. La collaboration inclut les commentaires en ligne et les versions nommées de documents.
