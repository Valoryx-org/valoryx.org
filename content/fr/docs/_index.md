...
Ouvrez [http://localhost:3000](http://localhost:3000) et enregistrez votre premier utilisateur — il devient automatiquement Super Admin.
...
- **Permissions RBAC** — 5 rôles : Super Admin, Admin, Editor, Commenter, Viewer
