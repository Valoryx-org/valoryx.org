...
| **Workspace Admin** | Робочий простір | Admin + управління налаштуваннями робочого простору, конфігурацією git, темою |
| **Super Admin** | Платформа | Повний доступ до всіх робочих просторів + налаштування платформи |
