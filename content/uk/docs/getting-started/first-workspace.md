...
| **Учасник** | Користувач із роллю в робочому просторі (від Viewer до Workspace Admin) |
...
1. Увійдіть як Super Admin або Workspace Admin
...
| **Workspace Admin** | Так | Так | Так | Так | Так |
| **Super Admin** | Повний доступ до платформи в усіх робочих просторах |
