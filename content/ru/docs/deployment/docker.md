...
Первый зарегистрированный пользователь становится **Super Admin** с полным доступом к платформе. Ручной шаг `init` не требуется — контейнер готов к использованию сразу.
