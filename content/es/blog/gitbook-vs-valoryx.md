...
## Precios
GitBook: $6,70/usuario/mes (team), precio personalizado (business). Valoryx: Community (gratuito para siempre, editores ilimitados), Team ($29/mes), Business ($79/mes). Veredicto: Valoryx es gratuito para equipos pequeños; el precio por workspace supera al precio por usuario para equipos más grandes.
