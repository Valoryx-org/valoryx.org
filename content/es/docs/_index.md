...
Abra [http://localhost:3000](http://localhost:3000) y registre su primer usuario; este se convierte automáticamente en Super Admin.
...
- **Permisos RBAC** — 5 roles: Super Admin, Admin, Editor, Commenter, Viewer
