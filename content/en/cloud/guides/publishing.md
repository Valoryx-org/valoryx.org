...
description: Turn your workspace into a live documentation site with one click.
weight: 2
---
...
1. Go to **Workspace Settings** → **Published Docs**
2. Toggle **Enable publishing**
3. Your docs are instantly live at `app.valoryx.dev/p/your-workspace-slug/`
...
3. Add the DNS record shown (a CNAME pointing to our servers)
4. SSL certificate is provisioned automatically — no setup needed
